...
/**
 * Created by asadulloh on 3/04/20.
 */
public class Datasource {

    public static final String DB_NAME = "music.db";

    public static final String CONNECTION_STRING = "jdbc:sqlite:D:\\JavaProjects\\MusicUI\\" + DB_NAME;
        ...
        try (Statement statement = conn.createStatement();
            ...
            while (results.next()) {
                try {
                    ...
                    System.out.println("InterruptedL " + e.getMessage());
                }
